  ...
  zh: {
    ...
    profile: {
      ...
      biography: [
        ...
        "研究方向包括 **多模态大模型**、多模态推理，自然语言处理，尤其关注如何提升模型的多模态理解和推理能力。先后在智谱 AI 与阿里巴巴高德地图开展多模态大模型和视频推理相关研发实践。",
      ],
      facts: [
        { icon: "📍", text: "北京，中国" },
    ...
    publicationGroups: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            authors: "Zhicong Lu*, Changyuan Tian*, Peiguang Li, Li Jin, Sirui Wang, Wei Jia, Ying Shen, Guangluan Xu（* 共同第一作者）",
            venue: "ACL 2025 · CCF-A · 第六作者（前两位共同一作）",
    ...
    publicationGroups: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            title: "PIPER: Benchmarking and Prompting Event Reasoning Boundary of LLMs via Debiasing-Distillation Enhanced Tuning",
            authors: "Zhicong Lu*, Changyuan Tian*, Peiguang Li, Li Jin, Sirui Wang, Wei Jia, Ying Shen, Guangluan Xu (* Equal contribution)",
            venue: "ACL 2025 · CCF-A · Sixth Author (two co-first authors)",
