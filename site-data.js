const SITE_DATA = {
  zh: {
    ...
    profile: {
      shortName: "贾唯",
      name: "贾唯",
      englishName: "Jiawei Jia",
      role: "中国科学院大学博士研究生",
      affiliation: "中国科学院空天信息创新研究院 · 目标认知与应用技术国家重点实验室",
      footerName: "贾唯 · Jiawei Jia",
        ...
        items: [
          {
            ...
            authors: "Jiawei Jia (First Author), et al.",
            venue: "AAAI · 第一作者 · 已投稿",
  ...
  en: {
    labels: {
      pageTitle: "Jiawei Jia | Academic Homepage",
      profileAlt: "Portrait of Jiawei Jia",
    ...
    profile: {
      shortName: "Jiawei Jia",
      name: "Jiawei Jia",
      englishName: "贾唯",
      role: "PhD Candidate at UCAS",
